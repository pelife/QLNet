...
<<<<<<< HEAD
   ...
   public class RelativeDateBootstrapHelper<TS> : BootstrapHelper<TS>
   {
      ...
      public RelativeDateBootstrapHelper() : base() { } // required for generics
      public RelativeDateBootstrapHelper(Handle<Quote> quote) : base(quote) { }
      public RelativeDateBootstrapHelper(double quote) : base(quote) { }
